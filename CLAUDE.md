...
**Baseline:** 397 unit tests (~134ms) · 115+ E2E. Recall aggregation is in the Python sidecar; `apps/ai` has its own `pytest` suite. Test name format: `should {behaviour} when {condition}`.
