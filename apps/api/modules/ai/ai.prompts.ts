// Website/chat system prompt. Ported verbatim from the former packages/ai
// (core/prompts.ts) when AI logic moved to the Python sidecar — this is the one
// piece chatBegin still builds in TS (it has the workspace currency + agent
// settings on hand) and hands to the sidecar's LLM loop.
