...
export const websiteJa: WebsiteDictionary = {
  ...
  feedback: {
    metaTitle: "フィードバック — Oewang",
    metaDescription: "バグ報告や機能リクエストはこちらから。",
    heading: "フィードバック",
    subheading: "バグを見つけましたか？アイデアがありますか？教えてください。",
    typeLabel: "種類",
    typeBug: "バグ報告",
    typeFeatureRequest: "機能リクエスト",
    typeOther: "その他",
    messageLabel: "メッセージ",
    messagePlaceholder: "何が起きましたか？どんな機能が欲しいですか？",
    emailLabel: "メールアドレス",
    emailPlaceholder: "you@example.com",
    nameLabel: "名前（任意）",
    screenshotLabel: "スクリーンショットを添付（任意）",
    submit: "送信する",
    submitting: "送信中…",
