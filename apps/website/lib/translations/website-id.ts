...
export const websiteId: WebsiteDictionary = {
  ...
  feedback: {
    metaTitle: "Masukan — Oewang",
    metaDescription: "Laporkan bug atau ajukan fitur baru.",
    heading: "Masukan",
    subheading: "Menemukan bug atau punya ide? Kasih tau kami.",
    typeLabel: "Jenis",
    typeBug: "Laporan bug",
    typeFeatureRequest: "Permintaan fitur",
    typeOther: "Lainnya",
    messageLabel: "Pesan",
    messagePlaceholder: "Apa yang terjadi, atau apa yang ingin kamu lihat?",
    emailLabel: "Email",
    emailPlaceholder: "kamu@contoh.com",
    nameLabel: "Nama (opsional)",
    screenshotLabel: "Lampirkan screenshot (opsional)",
    submit: "Kirim masukan",
    submitting: "Mengirim…",
    success: "Terima kasih — masukan kamu sudah kami terima.",
