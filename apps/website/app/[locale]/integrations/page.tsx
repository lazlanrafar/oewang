...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const copy = {
    en: {
      ...
      description: "Connect Oewang with email, accounting, messaging, and storage tools to automate finance workflows.",
    },
    id: {
      title: "Integrasi – oewang",
      description: "Hubungkan Oewang dengan email, accounting, messaging, dan storage untuk otomatisasi alur keuangan.",
    },
    ja: {
      title: "連携 – oewang",
      description: "Oewangをメール、会計、メッセージ、ストレージツールと連携し、財務ワークフローを自動化します。",
    },
  };
      ...
      <main className="flex-1 pt-24">
        <section className="py-16 sm:py-20 border-b border-border/70">
          <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-3">Integration Directory</p>
            ...
            <p className="text-muted-foreground text-base sm:text-lg mt-5 max-w-2xl">
              Browse available integrations and open each detail page to learn capabilities, setup steps, and how it
              fits personal or team workspaces.
            </p>
          </div>
        </section>
