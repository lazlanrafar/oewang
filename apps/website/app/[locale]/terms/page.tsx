  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-serif tracking-tight mb-2">Terms and Conditions</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">1. Subscriptions</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">2. Fee Changes</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">3. Refunds</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">4. Content</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">5. Accounts</h2>
          <p className="text-muted-foreground leading-6 text-sm">
          ...
          <p className="text-muted-foreground leading-6 text-sm">You may not use a username that:</p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">6. Financial and Tax Disclaimer</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">7. Copyright Policy</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">8. Intellectual Property</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">9. Links to Other Websites</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">10. Termination</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">11. Limitation of Liability</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">12. Disclaimer</h2>
          <p className="text-muted-foreground leading-6 text-sm">
            You use the Service at your own risk. The Service is provided on an "AS IS" and "AS AVAILABLE" basis,
            without warranties of any kind.
          </p>
          <p className="text-muted-foreground leading-6 text-sm">We do not warrant that:</p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">13. Governing Law</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-lg tracking-tight mt-10">14. Changes</h2>
          <p className="text-muted-foreground leading-6 text-sm">
        ...
        <section className="space-y-4 mb-20">
          <h2 className="text-lg tracking-tight mt-10">15. Contact Us</h2>
          <p className="text-muted-foreground leading-6 text-sm">
