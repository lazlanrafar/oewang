      ...
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground leading-6 text-sm">
            ...
            <li>
              Financial data you provide: transactions, wallets, categories, contacts, debts, invoices, and related
              records.
            </li>
            ...
            <li>
              Technical and security data: request metadata, audit records, operational logs, and abuse prevention
              signals.
            </li>
          </ul>
        </section>
