...
export function detectIntentByRules(text: string): Intent {
  ...
  if (
    ...
    t.includes("expenses") ||
    t.includes("income") ||
    t.includes("pemasukan") ||
    t.includes("pendapatan") ||
    t.includes("revenue") ||
    t.includes("burn rate") ||
    t.includes("burn-rate") ||
    ...
    t.includes("overview") ||
    t.includes("berapa banyak") ||
    t.includes("how much did i spend")
  )
    return "analytics_query";
  if (t.includes("split") || t.includes("patungan") || t.includes("bagi bill"))
    return "split_bill";
